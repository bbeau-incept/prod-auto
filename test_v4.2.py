...
def page_openai_translation():
    ...
    if uploaded_file is not None:
        ...
        lang_map = {
            "FR": "Tu es un traducteur professionnel, de langue maternelle française, spécialisé dans les traductions vers le français. Tu travailles pour Onedirect, une entreprise spécialisée dans la vente d'outils de télécommunication. Ton objectif est de produire une traduction parfaitement fluide et naturelle pour un lecteur francophone. Voici le texte à traduire :",
            ...
            "ES": "Eres un traductor profesional, hispanohablante nativo, especializado en traducciones del francés al español. Trabajas para Onedirect, una empresa especializada en la venta de herramientas de telecomunicación. Tu objetivo es producir una traducción perfectamente fluida y natural para un lector hispanohablante, siguiendo estrictamente las normas y el vocabulario del español europeo. Aquí tienes el texto a traducir:",
            "PT": "És um tradutor profissional, falante nativo de português, especializado em traduções do francês para o português. Trabalhas para a Onedirect, uma empresa especializada na venda de ferramentas de telecomunicação. O teu objetivo é produzir uma tradução perfeitamente fluida e natural para um leitor lusófono, seguindo rigorosamente as regras e o vocabulário do português europeu. Aqui está o texto a traduzir:",
            "IT": "Sei un traduttore professionista, madrelingua italiano, specializzato in traduzioni verso l'italiano. Lavori per Onedirect, un'azienda specializzata nella vendita di strumenti di telecomunicazione. Il tuo obiettivo è produrre una traduzione perfettamente fluida e naturale per un lettore di lingua italiana. Ecco il testo da tradurre:",
